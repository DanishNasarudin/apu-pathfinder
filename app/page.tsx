...
export default async function Home({ searchParams }: Props) {
  const interFloorEdges: Edge[] = [
    ...
    { id: 99, from: "A-03-Stairs", to: "A-04-Stairs", fromId: 3, toId: 4 },
    { id: 99, from: "A-03-Lift", to: "A-04-Lift", fromId: 4, toId: 3 },
    { id: 99, from: "B-03-Lift", to: "B-04-Lift", fromId: 2, toId: 2 },
    { id: 99, from: "B-03-Stairs", to: "B-04-Stairs", fromId: 1, toId: 1 },
    { id: 99, from: "D-03-Stairs", to: "D-04-Stairs", fromId: 5, toId: 5 },
    { id: 99, from: "E-03-Stairs", to: "E-04-Stairs", fromId: 7, toId: 6 },
    { id: 99, from: "E-03-Lift", to: "E-04-Lift", fromId: 8, toId: 7 },
    // ----
    {
      id: 99,
      from: "S-04-Stairs-02",
    ...
    { id: 99, from: "A-04-Stairs", to: "A-05-Stairs", fromId: 4, toId: 3 },
    { id: 99, from: "A-04-Lift", to: "A-05-Lift", fromId: 3, toId: 4 },
    { id: 99, from: "B-04-Lift", to: "B-05-Lift", fromId: 2, toId: 2 },
    { id: 99, from: "B-04-Stairs", to: "B-05-Stairs", fromId: 1, toId: 1 },
    { id: 99, from: "D-04-Stairs", to: "D-05-Stairs", fromId: 5, toId: 5 },
    { id: 99, from: "E-04-Stairs", to: "E-05-Stairs", fromId: 6, toId: 6 },
    { id: 99, from: "E-04-Lift", to: "E-05-Lift", fromId: 7, toId: 7 },
    // ----
    {
      id: 99,
      from: "S-05-Stairs-02",
    ...
    { id: 99, from: "A-05-Stairs", to: "A-06-Stairs", fromId: 3, toId: 71 },
    { id: 99, from: "A-05-Lift", to: "A-06-Lift", fromId: 4, toId: 70 },
    { id: 99, from: "B-05-Lift", to: "B-06-Lift", fromId: 2, toId: 11 },
    { id: 99, from: "B-05-Stairs", to: "B-06-Stairs", fromId: 1, toId: 64 },
    { id: 99, from: "D-05-Stairs", to: "D-06-Stairs", fromId: 5, toId: 65 },
    { id: 99, from: "E-05-Stairs", to: "E-06-Stairs", fromId: 6, toId: 67 },
    { id: 99, from: "E-05-Lift", to: "E-06-Lift", fromId: 7, toId: 66 },
    // ----
